...
use gpui::{div, prelude::*, px, svg, Context, HighlightStyle};
use zedb_core::{HistoryEntry, SavedQuery};

use super::model::{HistoryTab, HISTORY_SHOWN};
...
pub(crate) fn sort_saved(saved: &mut [SavedQuery]) {
    saved.sort_by(|a, b| {
        b.favorite
            .cmp(&a.favorite)
...
pub(crate) fn default_name(sql: &str) -> String {
