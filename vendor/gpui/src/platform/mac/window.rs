...
extern "C" fn window_did_change_key_status(this: &Object, selector: Sel, _: id) {
    ...
    // zeDB patch (upstream zed#51035, commit d7d8fcd): resignKeyWindow
    // synchronously re-enters this function via windowDidResignKey;
    // sending it while the window-state lock is held deadlocks the
    // main thread. Drop the lock first.
