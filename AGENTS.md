...
This project is indexed by GitNexus as **zeDB** (2746 symbols, 8167 relationships, 235 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
