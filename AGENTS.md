...
This project is indexed by GitNexus as **zeDB** (2707 symbols, 8042 relationships, 227 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
