...
This project is indexed by GitNexus as **zeDB** (2784 symbols, 8292 relationships, 242 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
