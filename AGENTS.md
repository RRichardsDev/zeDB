...
This project is indexed by GitNexus as **zeDB** (2632 symbols, 7860 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
