...
This project is indexed by GitNexus as **zeDB** (2756 symbols, 8199 relationships, 236 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
