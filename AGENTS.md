...
This project is indexed by GitNexus as **zeDB** (2839 symbols, 8429 relationships, 247 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
