...
This project is indexed by GitNexus as **zeDB** (2444 symbols, 7128 relationships, 212 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
