...
This project is indexed by GitNexus as **zeDB** (2770 symbols, 8256 relationships, 241 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
