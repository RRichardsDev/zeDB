...
This project is indexed by GitNexus as **zeDB** (2844 symbols, 8435 relationships, 247 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
