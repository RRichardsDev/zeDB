...
This project is indexed by GitNexus as **zeDB** (5127 symbols, 13599 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
