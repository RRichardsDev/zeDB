...
This project is indexed by GitNexus as **zeDB** (2660 symbols, 7925 relationships, 224 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
