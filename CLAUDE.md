...
This project is indexed by GitNexus as **zeDB** (2659 symbols, 7900 relationships, 227 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
