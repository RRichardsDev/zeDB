...
This project is indexed by GitNexus as **zeDB** (2518 symbols, 7350 relationships, 218 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
