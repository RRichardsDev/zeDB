...
This project is indexed by GitNexus as **zeDB** (3160 symbols, 9355 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
