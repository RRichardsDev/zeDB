...
This project is indexed by GitNexus as **zeDB** (2688 symbols, 8030 relationships, 229 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
