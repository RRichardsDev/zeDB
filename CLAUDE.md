...
This project is indexed by GitNexus as **zeDB** (2684 symbols, 8009 relationships, 224 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
