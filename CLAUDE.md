...
This project is indexed by GitNexus as **zeDB** (2742 symbols, 8151 relationships, 234 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
