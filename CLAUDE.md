...
This project is indexed by GitNexus as **zeDB** (2748 symbols, 8191 relationships, 236 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
